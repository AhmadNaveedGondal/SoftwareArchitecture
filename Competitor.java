...
public class Competitor {
  ...
  public String getFullDetails() {
    StringBuilder result = new StringBuilder();
    result.append(String.format("Competitor Number %d, Name %s.%n", comp_num, comp_name));
    ...
    result.append(String.format("%nOverall score of %.1f.", calculateOverallScore()));

    return result.toString();
  }

  public String getShortDetails() {
    return String.format("CN %d (%s)scored overall score %.1f.", comp_num, getInitials(), calculateOverallScore());
  }
